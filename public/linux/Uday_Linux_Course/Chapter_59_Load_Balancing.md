...
```mermaid
graph TD
    subgraph The_HA_Load_Balancing_Array ["The HA Load Balancing Array"]
...
```mermaid
graph LR
    subgraph Solving_the_Single_Point_of_Failure ["Solving the Single Point of Failure"]
        Internet["Internet"]
        
        subgraph Active_Passive_HA_Pair_Keepalived ["Active-Passive HA Pair (Keepalived)"]
