...
```mermaid
graph TD
    subgraph The_Key_Based_Login_Process ["The Key-Based Login Process"]
...
```mermaid
graph LR
    subgraph The_ssh_Directory_Structure_Permissions_Matter ["The ~/.ssh Directory Structure (Permissions Matter!)"]
